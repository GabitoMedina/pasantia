...
<div class="btn-group pull-right">
	<a href="index.php?view=newproofrm" class="btn btn-default"><i class='fa fa-smile-o'></i> Nuevo Cliente</a>
<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="report/clients-word.php">Word 2007 (.docx)</a></li>
		...
		<h1>Directorio de Proformas</h1>
<br>
		<?php

		$users = ProformaData::getClients();
		if(count($users)>0){
			// si hay usuarios
			?>
