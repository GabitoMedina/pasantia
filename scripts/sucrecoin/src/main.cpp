...
uint256 hashGenesisBlock("0xd6e61dd3771f63fb713d200ace62e83137567abc501c2c48dcc2b874c77f5d39");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
   ...
   if(nHeight == 1)
          nSubsidy = 212444 * COIN;
            
             if(nHeight > 6982 && nHeight < 7008)
              nSubsidy = 16 * COIN;
            
             if(nHeight > 7008 && nHeight < 7025)
                   nSubsidy = 212444 * COIN;
    ...
    // Subsidy is cut in half every 525800 blocks
    nSubsidy >>= (nHeight / 525800);
    return nSubsidy + nFees;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1513586126, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Compilado ubuntu";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04212e3cd9165e3c2b14560da45391c29384b1c5606f2bb5f6b8c5a7990f8268924c38212b45df314b485367bb9a104b47767d6f9678b8ebc51bb2536117d78f23") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1513586126;
        ...
        assert(block.hashMerkleRoot == uint256("0xd6c3de0a9c38d487a66656d53cb61a8bbdaa56a13f892c55d40c93c74a216e62"));
...
unsigned char pchMessageStart[4] = { 0x05, 0xd3, 0xa5, 0x83 }; // SucreCoin: increase each by adding 2 to bitcoin's value.
