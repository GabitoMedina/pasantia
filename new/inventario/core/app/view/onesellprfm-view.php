...
<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="report/index.php?id=<?php echo $_GET["id"];?>">Word 2007 (.docx)</a></li>
  </ul>
  <ul class="dropdown-menu" role="menu">
    <li><a href="report/index.php" target="_blank">PDF imprimir</a></li>
  </ul>
</div>
<h1>Resumen de Venta</h1>
<?php if(isset($_GET["id"]) && $_GET["id"]!=""):?>
<?php
$sell = SellprfmData::getById($_GET["id"]);
