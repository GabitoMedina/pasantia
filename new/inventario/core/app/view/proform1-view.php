...
$(document).ready(function(){
	$("#searchp").on("submit",function(e){
		...
		$.get("./?action=searchproductproform",$("#searchp").serialize(),function(data){
...
<form method="post" class="form-horizontal" id="processprfm" action="index.php?view=processprfm">
<h2>Resumen</h2>
