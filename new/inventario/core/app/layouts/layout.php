...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Invps593 | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>INVPS</b>593</span>
        </a>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="./index.php?view=proform1"><i class='fa fa-file-archive-o'></i> <span>Proformas</span></a></li>
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2018<a href="http://vps593.com/" target="_blank"> Vps593.com</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">INVPS<b>593</b></a>
      </div><!-- /.login-logo -->
