    ...
    <div class="col-md-12">
        <div id="proforma" style="width: 70%; margin: 0 auto; padding: 0 30px;">
            <div name="header">
                ...
                <div class="col-md-9">
                    <h2 class="text-center bold" style="color: red;" name="insitucacion" >VPS593.COM</h2>
                    <h4 class="text-center bold">REPARACION Y VENTAS DE COMPUTADORAS</h4>
                    <h5 class="text-center bold">Carlos Gamarra</h5>
...
<!--                        <p class="text-justify">
                        ...
                        <dl >
                            ...
                            <dd class="text-justify">
                                El precio puede variar dependiendo las partes que el cliente quiera cambiar.
                                Confirmar la compra a mi telefono 0997890738, para el pago, puede depositar a mi cuenta de ahorros Banco Pichincha a nombre de Braulio shasash
                            </dd>
                            <br>
