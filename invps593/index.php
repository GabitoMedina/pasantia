                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                          ...
                          <ul class="treeview-menu">
                            ...
                            <li class="treeview">
                              <a ><i class='fa fa-product-hunt'></i> <span>Productos</span> <i class="fa fa-angle-left pull-right"></i></a>
                              <ul class="treeview-menu">
                                <li >
                                    <a href="MVC/View/VenderProd/venderprod.php">
                                        <i class="fa fa-database"></i> <span>Factura</span>
                                    </a>
                                </li>
                                <li><a href="MVC/View/NotaVenta/notaventa.php">
                                  <i class="	fa fa-file-text-o"></i><span>Nota de Venta</span>
                                    </a>
                              </li>
